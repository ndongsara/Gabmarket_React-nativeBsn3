            ...
            if (event.data.action === 'getFieldsData') {
                ...
                fields.forEach(function(field) {
                    ...
                    inputs.forEach(function(input) {
                        if (input.value.trim() == '' || (['control_scale', 'control_radio', 'control_checkbox'].indexOf(fieldType) > -1 && !input.checked)) return;

                        if (fieldType === 'control_checkbox') {
                            tempKey = tempKey || input.id;
                            tempValue = tempValue ? tempValue + ',' + input.value : input.value;
                            return;
                        }
